...
INSERT INTO vibe_tags (id, slug, display_name, emoji, sentiment_group, sort_order, is_active) VALUES
  ...
  ('mid', 'mid', 'Mid', '😐', 'neutral', 50, 1),
  ('chaos', 'chaos', 'Chaos', '🌪', 'neutral', 60, 1),
  ('overrated', 'overrated', 'Overrated', '👎', 'negative', 70, 1),
  ('tourist_trap', 'tourist_trap', 'Tourist Trap', '📸', 'negative', 80, 1),
  ('needs_prayer', 'needs_prayer', 'Needs Prayer', '🙏', 'negative', 90, 1),
  ('emotionally_damaging', 'emotionally_damaging', 'Emotionally Damaging', '💀', 'negative', 100, 1)
